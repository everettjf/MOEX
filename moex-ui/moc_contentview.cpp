...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ContentView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ContentView_t qt_meta_stringdata_ContentView = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ContentView"
...
const QMetaObject ContentView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ContentView.data,
      qt_meta_data_ContentView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
