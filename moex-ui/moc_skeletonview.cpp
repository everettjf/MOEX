...
struct qt_meta_stringdata_SkeletonView_t {
    QByteArrayData data[4];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SkeletonView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SkeletonView_t qt_meta_stringdata_SkeletonView = {
    {
QT_MOC_LITERAL(0, 0, 12), // "SkeletonView"
QT_MOC_LITERAL(1, 13, 15), // "clickedTreeNode"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5) // "index"

    },
    "SkeletonView\0clickedTreeNode\0\0index"
};
...
void SkeletonView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickedTreeNode((*reinterpret_cast< QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject SkeletonView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SkeletonView.data,
      qt_meta_data_SkeletonView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SkeletonView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SkeletonView.stringdata0))
